...
impl Accel {
    fn push_handle(&self, handle: api::Mesh, transform: Mat4, visible: bool, opaque: bool) {
        ...
        mesh_handles.push(Arc::new(MeshHandle {
    ...
    pub fn push_mesh(&self, mesh: &Mesh, transform: Mat4, visible: bool, opaque: bool) {
        self.push_handle(mesh.handle.handle, transform, visible, opaque)
    }
    pub fn set_mesh(
        &self,
        index: usize,
