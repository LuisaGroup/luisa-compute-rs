...
impl Expr<Float2> {
    ...
    pub fn cast_f64(self) -> Expr<Double2> { self.as_::<Double2>() }
    ...
    pub fn cast_f16(self) -> Expr<Half2> { self.as_::<Half2>() }
...
impl Expr<Float3> {
    ...
    pub fn cast_f64(self) -> Expr<Double3> { self.as_::<Double3>() }
    ...
    pub fn cast_f16(self) -> Expr<Half3> { self.as_::<Half3>() }
...
impl Expr<Float4> {
    ...
    pub fn cast_f64(self) -> Expr<Double4> { self.as_::<Double4>() }
    ...
    pub fn cast_f16(self) -> Expr<Half4> { self.as_::<Half4>() }
...
impl Expr<Int2> {
    ...
    pub fn cast_f32(self) -> Expr<Float2> { self.as_::<Float2>() }
    pub fn as_uint2(self) -> Expr<Uint2> { self.as_::<Uint2>() }
    pub fn cast_u32(self) -> Expr<Uint2> { self.as_::<Uint2>() }
    pub fn as_double2(self) -> Expr<Double2> { self.as_::<Double2>() }
    pub fn cast_f64(self) -> Expr<Double2> { self.as_::<Double2>() }
...
impl Expr<Int3> {
    ...
    pub fn cast_f32(self) -> Expr<Float3> { self.as_::<Float3>() }
    pub fn as_uint3(self) -> Expr<Uint3> { self.as_::<Uint3>() }
    pub fn cast_u32(self) -> Expr<Uint3> { self.as_::<Uint3>() }
    pub fn as_double3(self) -> Expr<Double3> { self.as_::<Double3>() }
    pub fn cast_f64(self) -> Expr<Double3> { self.as_::<Double3>() }
...
impl Expr<Int4> {
    ...
    pub fn cast_f32(self) -> Expr<Float4> { self.as_::<Float4>() }
    pub fn as_uint4(self) -> Expr<Uint4> { self.as_::<Uint4>() }
    pub fn cast_u32(self) -> Expr<Uint4> { self.as_::<Uint4>() }
    pub fn as_double4(self) -> Expr<Double4> { self.as_::<Double4>() }
    pub fn cast_f64(self) -> Expr<Double4> { self.as_::<Double4>() }
