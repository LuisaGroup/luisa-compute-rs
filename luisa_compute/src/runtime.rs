...
impl Command {
    pub fn upload_buffer<T: Value>(buffer: &Buffer<T>, offset: usize, data: &[T]) -> Self {
        catch_abort! {{
            let count = data.len();
    ...
    pub fn download_buffer<T: Value>(buffer: &Buffer<T>, offset: usize, data: &mut [T]) -> Self {
        catch_abort! {{
            let count = data.len();
    ...
    pub fn copy_buffer_to_buffer<T: Value>(
        src: &Buffer<T>,
        src_offset: usize,
        dst: &Buffer<T>,
        dst_offset: usize,
    ...
    pub fn copy_buffer_to_texture<T: Value>(
        buffer: &Buffer<T>,
        buffer_offset: usize,
        texture: &Texture,
    ...
    pub fn copy_texture_to_buffer<T: Value>(
        buffer: &Buffer<T>,
        buffer_offset: usize,
        texture: &Texture,
        storage: PixelStorage,
